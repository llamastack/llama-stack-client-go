...
func TestSafetyRunShield(t *testing.T) {
	...
	_, err := client.Safety.RunShield(context.TODO(), ogxclient.SafetyRunShieldParams{
		Messages: []ogxclient.SafetyRunShieldParamsMessageUnion{{
			OfUser: &ogxclient.SafetyRunShieldParamsMessageUser{
				Content: ogxclient.SafetyRunShieldParamsMessageUserContentUnion{
