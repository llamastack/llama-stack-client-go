...
func TestBatchNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Batches.New(context.TODO(), ogxclient.BatchNewParams{
		CompletionWindow: ogxclient.BatchNewParamsCompletionWindow24h,
		Endpoint:         "endpoint",
		InputFileID:      "input_file_id",
		IdempotencyKey:   ogxclient.String("idempotency_key"),
...
func TestBatchListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Batches.List(context.TODO(), ogxclient.BatchListParams{
