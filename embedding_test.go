...
func TestEmbeddingNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Embeddings.New(context.TODO(), ogxclient.EmbeddingNewParams{
		Input: ogxclient.EmbeddingNewParamsInputUnion{
			OfString: ogxclient.String("string"),
		},
		Model:          "model",
		Dimensions:     ogxclient.Int(1),
		EncodingFormat: ogxclient.EmbeddingNewParamsEncodingFormatFloat,
