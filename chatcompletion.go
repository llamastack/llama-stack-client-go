...
type ChatCompletionNewResponseChoiceMessageToolCall struct {
	...
	Function ChatCompletionNewResponseChoiceMessageToolCallFunction `json:"function" api:"nullable"`
...
type ChatCompletionGetResponseChoiceMessageToolCall struct {
	...
	ID string `json:"id" api:"nullable"`
	// Function call details for OpenAI-compatible tool calls.
	Function ChatCompletionGetResponseChoiceMessageToolCallFunction `json:"function" api:"nullable"`
	// Index of the tool call in the list.
	Index int64 `json:"index" api:"nullable"`
	// Must be 'function' to identify this as a function call.
	//
...
type ChatCompletionGetResponseInputMessageAssistantToolCall struct {
	...
	ID string `json:"id" api:"nullable"`
	// Function call details for OpenAI-compatible tool calls.
	Function ChatCompletionGetResponseInputMessageAssistantToolCallFunction `json:"function" api:"nullable"`
	// Index of the tool call in the list.
	Index int64 `json:"index" api:"nullable"`
	// Must be 'function' to identify this as a function call.
	//
...
type ChatCompletionListResponseDataChoiceMessageToolCall struct {
	...
	ID string `json:"id" api:"nullable"`
	// Function call details for OpenAI-compatible tool calls.
	Function ChatCompletionListResponseDataChoiceMessageToolCallFunction `json:"function" api:"nullable"`
	// Index of the tool call in the list.
	Index int64 `json:"index" api:"nullable"`
	// Must be 'function' to identify this as a function call.
	//
...
type ChatCompletionListResponseDataInputMessageAssistantToolCall struct {
	...
	ID string `json:"id" api:"nullable"`
	// Function call details for OpenAI-compatible tool calls.
	Function ChatCompletionListResponseDataInputMessageAssistantToolCallFunction `json:"function" api:"nullable"`
	// Index of the tool call in the list.
	Index int64 `json:"index" api:"nullable"`
	// Must be 'function' to identify this as a function call.
	//
